...
class AeroGtoPredictor:
    def __init__(self, config_path, mode="test", model_path=None, device_str="cuda"):
        ...
        train_dataset = AeroGtoDataset(
            ...
            spatial_stride=[1, 1, 1], # data_cfg.get("spatial_stride", 1),
        ...
        if mode == "test":
            ...
            self.dataset = AeroGtoDataset(
                ...
                spatial_stride=[1, 1, 1], # self.args.data.get("spatial_stride", 1),
...
if __name__ == "__main__":
    ...
    # === 配置区域 ===
    CONFIG_PATH = f"config/EasyPool_2D_Res_0311/aerogto_HR_easypool_2d_log_velocity.json" 
